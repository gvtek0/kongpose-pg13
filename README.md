...
- With upgraded pgsql image to 13

- Also included a .env file which allows running on Windows without including "KONG_DATABASE=postgres" in the DB implementation below.

- Had some issues with 14/15 vers of pgsql but will review and attempt that upgrade fresh soon
